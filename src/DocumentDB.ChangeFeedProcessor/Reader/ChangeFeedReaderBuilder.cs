...
namespace Microsoft.Azure.Documents.ChangeFeedProcessor.Reader
{
    ...
    /// </code>
    /// </example>
    public class ChangeFeedReaderBuilder
    {
        ...
        private IPartitionReaderFactory partitionReaderFactory;
        ...
        /// <returns>The instance of <see cref="ChangeFeedReaderBuilder"/> to use.</returns>
        public ChangeFeedReaderBuilder WithHostName(string hostName)
        {
        ...
        /// <returns>The instance of <see cref="ChangeFeedReaderBuilder"/> to use.</returns>
        public ChangeFeedReaderBuilder WithFeedCollection(DocumentCollectionInfo feedCollectionLocation)
        {
        ...
        /// <summary>
        /// Gets feed collection information
        /// </summary>
        /// <returns>Feed collection information</returns>
        public DocumentCollectionInfo GetFeedCollectionInfo() => this.feedCollectionLocation;
        ...
        /// <returns>The instance of <see cref="ChangeFeedReaderBuilder"/> to use.</returns>
        public ChangeFeedReaderBuilder WithFeedDocumentClient(DocumentClient feedDocumentClient)
        {
        ...
        /// <returns>The instance of <see cref="ChangeFeedReaderBuilder"/> to use.</returns>
        public ChangeFeedReaderBuilder WithFeedDocumentClient(IChangeFeedDocumentClient feedDocumentClient)
        {
            if (feedDocumentClient == null) throw new ArgumentNullException(nameof(feedDocumentClient));
        ...
        /// <returns>The instance of <see cref="ChangeFeedReaderBuilder"/> to use.</returns>
        public ChangeFeedReaderBuilder WithProcessorOptions(ChangeFeedProcessorOptions changeFeedProcessorOptions)
        {
        ...
        /// <returns>The instance of <see cref="ChangeFeedReaderBuilder"/> to use.</returns>
        public ChangeFeedReaderBuilder WithDatabaseResourceId(string databaseResourceId)
        {
        ...
        /// <returns>The instance of <see cref="ChangeFeedReaderBuilder"/> to use.</returns>
        public ChangeFeedReaderBuilder WithCollectionResourceId(string collectionResourceId)
        {
        ...
        /// <summary>
        /// Get the collection resource Id
        /// </summary>
        /// <returns>Returns collection resource id</returns>
        public string GetCollectionResourceId() => this.collectionResourceId;
        ...
        /// <returns>The instance of <see cref="ChangeFeedReaderBuilder"/> to use.</returns>
        public ChangeFeedReaderBuilder WithLeaseCollection(DocumentCollectionInfo leaseCollectionLocation)
        {
        ...
        /// <returns>The instance of <see cref="ChangeFeedReaderBuilder"/> to use.</returns>
        public ChangeFeedReaderBuilder WithLeaseDocumentClient(DocumentClient leaseDocumentClient)
        {
        ...
        /// <returns>The instance of <see cref="ChangeFeedReaderBuilder"/> to use.</returns>
        public ChangeFeedReaderBuilder WithLeaseDocumentClient(IChangeFeedDocumentClient leaseDocumentClient)
        {
            if (leaseDocumentClient == null) throw new ArgumentNullException(nameof(leaseDocumentClient));
        ...
        /// <returns>The instance of <see cref="ChangeFeedReaderBuilder"/> to use.</returns>
        public ChangeFeedReaderBuilder WithPartitionLoadBalancingStrategy(IParitionLoadBalancingStrategy strategy)
        {
        ...
        /// <summary>
        /// Sets the <see cref="IPartitionReaderFactory"/> to be used to create <see cref="IPartitionReader"/> for partition processing.
        /// </summary>
        /// <param name="partitionReaderFactory">The instance of <see cref="IPartitionReaderFactory"/> to use.</param>
        /// <returns>The instance of <see cref="ChangeFeedReaderBuilder"/> to use.</returns>
        public ChangeFeedReaderBuilder WithPartitionReaderFactory(IPartitionReaderFactory partitionReaderFactory)
        {
        ...
        /// <returns>The instance of <see cref="ChangeFeedReaderBuilder"/> to use.</returns>
        public ChangeFeedReaderBuilder WithLeaseManager(ILeaseManager leaseManager)
        {
        ...
        public async Task<IChangeFeedReader> BuildAsync()
        {
            ...
            IPartitionReaderManager partitionManager = await this.BuildPartitionManagerAsync(leaseManager).ConfigureAwait(false);
            return new ChangeFeedReader(partitionManager);
        }
        ...
        private async Task<IPartitionReaderManager> BuildPartitionManagerAsync(ILeaseManager leaseManager)
        {
            ...
            var actualPartitionReaderFactory = this.partitionReaderFactory ??
                new PartitionReaderFactory(this.feedDocumentClient, this.changeFeedProcessorOptions, leaseManager, collectionSelfLink);
            ...
            return new PartitionReaderManager(bootstrapper, partitionController, partitionLoadBalancer);
        }
